...
public class ValidLoginTestCase extends BaseTest {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.findElement(By.name("username")).sendKeys(flib.readDataFromPropertyFile(PROP_PATH,"Username"));
		// identify password Text Box and pass password
		driver.findElement(By.name("pwd")).sendKeys(flib.readDataFromPropertyFile(PROP_PATH,"Password"));
